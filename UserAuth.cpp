...
string UserAuth::valueToString(RadiusVendorSpecificAttribute *vsa)
{
	...
	/* IF-statement was generated from dictionary file of freeradius 1.0.2 with vsahelper.pl */
		...
		(id == VENDOR_USR && type == ATTRIBUTE_CALL_TERMINATE_IN_GMT) || (id == VENDOR_USR && type == ATTRIBUTE_CALL_CONNECT_IN_GMT) || (id == VENDOR_USR && type == ATTRIBUTE_CALL_ARRIVAL_IN_GMT) || (id == VENDOR_USR && type == ATTRIBUTE_EVENT_DATE_TIME) || (id == VENDOR_USR && type == ATTRIBUTE_CALL_END_DATE_TIME) || (id == VENDOR_USR && type == ATTRIBUTE_CALL_START_DATE_TIME) || (id == VENDOR_USR && type == ATTRIBUTE_SERVER_TIME))
	{
		sprintf(buffer, "%d", vsa->intFromBuf());
		return string(buffer);
	}
